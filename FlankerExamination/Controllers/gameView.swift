...
class gameView: UIViewController {
    ...
    @objc func counter(){
        ...
        case -24...(-23):
            ...
            //    response_time = 1000 * (self.PostData[i.count]["response_time"] as! Double)
            //}
...
//this is an objc function so it can be called by a selector
    ...
    func averageResponseTime() -> Double {
        ...
        let average = 1000.0 * round(1000.0 * responseSum)/1000.0/20.0
        print("Average response time",average)
        //let average = 1000.0 * responseSum / 20.0
        return average
    }
