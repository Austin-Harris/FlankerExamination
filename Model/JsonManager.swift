...
//"http://sparkerserver.research.utc.edu:3001/apis/school/"
    func fetchSchools(completion: @escaping (Result<[School], Error>) -> ()){
        ...
        let urlString = "http://3.128.94.184:3001/apis/school/"
    ...
    func createPost(candidate_id: String, school_id: Int, test_time: Double, test_instance_id: Int, test_id: Int, test_entries: [[String: Any]], completion: (Error?) -> ()) {
        //let urlString = "http://18.225.11.159:3000/apis/sparkerserver.research.utc.edu:3001"
        let urlString = "http://3.128.94.184:3001/apis/save-test"
        guard let url = URL(string: urlString) else {return}
